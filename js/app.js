...
let menuHeaderB = document.querySelector(".header__main");
let menuHeaderBA = document.querySelector(".header__body");
if (iconMenu != null) {
	let delay = 500;
	let menuBody = document.querySelector(".menu-header__items");
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
			...
			menuHeaderB.classList.toggle("_active");
			menuHeaderBA.classList.toggle("_active");
		}
	});
};
function menu_close() {
...
$(document).ready(function () {
	// Выполни функцию при скролле
	const navOffset = $('.header__main').offset().top;
